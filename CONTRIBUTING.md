...
- Only shared material is tracked: `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, `.tasks.toml`, `.github/workflows/`, `bin/`, `.agents/skills/`, and `skills/`.
  ...
  Repository-root `AGENTS.md.bak-*` snapshots are gitignored to keep obsolete agent contracts out of future commits, while matching files in nested projects remain unaffected.
