...
- [docs/buzz-loopback-adapter.md](docs/buzz-loopback-adapter.md) - the additive, loopback-only Buzz bearings publisher: its invariants, usage, and verification evidence.
