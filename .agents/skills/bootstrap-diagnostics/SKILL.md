...
- `TANGLE: <remediation>` - the primary checkout is stranded on a feature branch instead of its default branch; `docs/architecture.md` ("Worktrees, not branches in your checkout") explains why this guard exists and what it protects.
